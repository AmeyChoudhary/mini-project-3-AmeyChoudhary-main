...
forktest(void)
{
  ...
  3e:	42e50513          	addi	a0,a0,1070 # 468 <setpriority+0xa>
  ...
  68:	41450513          	addi	a0,a0,1044 # 478 <setpriority+0x1a>
  ...
  b8:	41450513          	addi	a0,a0,1044 # 4c8 <setpriority+0x6a>
  ...
  d4:	3c850513          	addi	a0,a0,968 # 498 <setpriority+0x3a>
  ...
  ee:	3c650513          	addi	a0,a0,966 # 4b0 <setpriority+0x52>
