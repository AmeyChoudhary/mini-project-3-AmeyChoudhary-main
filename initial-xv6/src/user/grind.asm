...
go(int which_child)
{
  ...
  int fd = -1;
     ...
     100:	f24a0a13          	addi	s4,s4,-220 # 2020 <buf.1242>
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     f6a:	f56080e7          	jalr	-170(ra) # ebc <write>
}
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    13c2:	b66080e7          	jalr	-1178(ra) # f24 <sbrk>
  if(p == (char*)-1)
