...
main(int argc, char *argv[]) {
  ...
  10:	3a4080e7          	jalr	932(ra) # 3b0 <getreadcount>
  14:	892a                	mv	s2,a0

    int rc = fork();
  16:	00000097          	auipc	ra,0x0
  1a:	2ea080e7          	jalr	746(ra) # 300 <fork>
  ...
  34:	2f0080e7          	jalr	752(ra) # 320 <read>
    for (i = 0; i < 100000; i++) {
  ...
  4a:	2c2080e7          	jalr	706(ra) # 308 <exit>
        (void) wait(&rc);
  4e:	fdc40513          	addi	a0,s0,-36
  52:	00000097          	auipc	ra,0x0
  56:	2be080e7          	jalr	702(ra) # 310 <wait>
        int x2 = getreadcount();
  5a:	00000097          	auipc	ra,0x0
  5e:	356080e7          	jalr	854(ra) # 3b0 <getreadcount>
        printf("XV6_TEST_OUTPUT %d\n", total);
  62:	412505bb          	subw	a1,a0,s2
  66:	00000517          	auipc	a0,0x0
  6a:	7da50513          	addi	a0,a0,2010 # 840 <malloc+0xea>
  6e:	00000097          	auipc	ra,0x0
  72:	62a080e7          	jalr	1578(ra) # 698 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 408:	45c50513          	addi	a0,a0,1116 # 860 <digits>
 40c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d4:	390b8b93          	addi	s7,s7,912 # 860 <digits>
 ...
 614:	24890913          	addi	s2,s2,584 # 858 <malloc+0x102>
        while(*s != 0){
