...
main(int argc, char *argv[]) {
  ...
  14:	3ac080e7          	jalr	940(ra) # 3bc <getreadcount>
  18:	8a2a                	mv	s4,a0
    int x2 = getreadcount();
  1a:	00000097          	auipc	ra,0x0
  1e:	3a2080e7          	jalr	930(ra) # 3bc <getreadcount>
  22:	892a                	mv	s2,a0
    char buf[100];
    (void) read(4, buf, 1);
  24:	4605                	li	a2,1
  ...
  30:	300080e7          	jalr	768(ra) # 32c <read>
    int x3 = getreadcount();
  34:	00000097          	auipc	ra,0x0
  38:	388080e7          	jalr	904(ra) # 3bc <getreadcount>
  3c:	89aa                	mv	s3,a0
  ...
  4e:	2e2080e7          	jalr	738(ra) # 32c <read>
    for (i = 0; i < 1000; i++) {
  ...
  5a:	366080e7          	jalr	870(ra) # 3bc <getreadcount>
  ...
  6e:	7e650513          	addi	a0,a0,2022 # 850 <malloc+0xee>
  72:	00000097          	auipc	ra,0x0
  76:	632080e7          	jalr	1586(ra) # 6a4 <printf>
    exit(0);
  7a:	4501                	li	a0,0
...
malloc(uint nbytes)
{
 ...
 83a:	b66080e7          	jalr	-1178(ra) # 39c <sbrk>
  if(p == (char*)-1)
