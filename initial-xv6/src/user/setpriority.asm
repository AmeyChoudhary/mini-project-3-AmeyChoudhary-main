...
int main(int argc, char **argv)
{
  ...
  16:	80e58593          	addi	a1,a1,-2034 # 820 <malloc+0xe6>
  1a:	4509                	li	a0,2
  1c:	00000097          	auipc	ra,0x0
  20:	632080e7          	jalr	1586(ra) # 64e <fprintf>
        exit(1);
  24:	4505                	li	a0,1
  26:	00000097          	auipc	ra,0x0
  2a:	2c6080e7          	jalr	710(ra) # 2ec <exit>
  2e:	84ae                	mv	s1,a1
    }
    int priority = atoi(argv[1]);
  30:	6588                	ld	a0,8(a1)
  32:	00000097          	auipc	ra,0x0
  36:	1ba080e7          	jalr	442(ra) # 1ec <atoi>
  3a:	892a                	mv	s2,a0
    int pid = atoi(argv[2]);
  3c:	6888                	ld	a0,16(s1)
  3e:	00000097          	auipc	ra,0x0
  42:	1ae080e7          	jalr	430(ra) # 1ec <atoi>
  46:	85aa                	mv	a1,a0
    setpriority(priority, pid);
  48:	854a                	mv	a0,s2
  4a:	00000097          	auipc	ra,0x0
  4e:	352080e7          	jalr	850(ra) # 39c <setpriority>
    exit(0);
  52:	4501                	li	a0,0
...
putc(int fd, char c)
{
 ...
 3ba:	f56080e7          	jalr	-170(ra) # 30c <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ec:	46850513          	addi	a0,a0,1128 # 850 <digits>
 3f0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5f8:	25490913          	addi	s2,s2,596 # 848 <malloc+0x10e>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 812:	b66080e7          	jalr	-1178(ra) # 374 <sbrk>
  if(p == (char*)-1)
